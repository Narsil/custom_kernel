...
fn main() {
     cc::Build::new()
        ...
        .include("/home/nicolas_huggingface_co/src/bloomserver/libtorch/include")
        .include("/home/nicolas_huggingface_co/src/bloomserver/libtorch/include/torch/csrc/api/include/")
    ...
    println!("cargo:rustc-link-lib=static=fused_bloom_attention_cuda");
